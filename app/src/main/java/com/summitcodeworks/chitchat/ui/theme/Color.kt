...
// Message Colors
val SentMessageBackground = Color(0xFF1DA1F2) // Twitter Blue
...
val SecondaryVariant = Color(0xFF018786) // Dark Teal
val OnBackground = Color(0xFF000000) // Black (Light) / White (Dark)
val OnSurface = Color(0xFF000000) // Black (Light) / White (Dark)
val SurfaceVariant = Color(0xFFE1E8ED) // Light Gray
